<template>
  <section class="tw-pt-32 lg:tw-pt-32 tw-px-2">
    <div class="tw-bg-white tw-container tw-mx-auto">
      <!-- Breadcrumb -->
          ...
          <ol class="tw-list-none tw-no-underline tw-inline-flex tw-items-center tw-space-x-1 md:tw-space-x-3">
            ...
            <li aria-current="page">
              <div class="tw-flex items-center">
                ...
                <span class="tw-text-gray-400 tw-ml-1 md:tw-ml-2 tw-text-sm tw-font-medium dark:tw-text-gray-500">Our Terms</span>
              </div>
            </li>
          </ol>
        </nav>
      <div class="header_area tw-mt-1">
        <h1
          class="tw-mt-2 border-top tw-text-center tw-text-red-600 heading_one"
        >
      ...
      <div class="tw-p-2">
        ...
        <p>A breakdown of Nairobi Drinks Limited is as below :</p>
        <ul>
          <li>
          ...
          <li>Only legal monies shall be accepted as mode of payment.</li>
          <li>
        ...
        <h5 class="tw-font-medium">AGE</h5>
        <p>
        ...
        <h5 class="tw-font-medium">RESPONSIBLE DRINKING</h5>
        <p>
          Nairobi Drinks Limited advocates for responsible drinking and shall
        ...
        <h5 class="tw-font-medium">ORDERS CANCELLATION and DELAYS</h5>
        <p>
        ...
        <h5 class="tw-font-medium">PAYMENT</h5>
        <p>
        ...
        <h5 class="tw-font-medium">DELIVERY CHARGES</h5>
        <p>
        ...
        <h5 class="tw-font-medium">BUYING ON CREDIT</h5>
        <p>
        ...
        <h5 class="tw-font-medium">PRIVACY OF CUSTOMER INFORMATION</h5>
        <p>
        ...
        <h5 class="tw-font-medium">CUSTOMER FEEDBACK</h5>
        <p>
  ...
  async asyncData({ $http }) {
    try {
      const meta = await $http
        .$get('metas/get-by-category/our-terms')
