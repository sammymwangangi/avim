  ...
  <div class="tw-pt-16 lg:tw-pt-32">
    <section>
      ...
      >
          ...
          <ol class="tw-list-none tw-no-underline tw-inline-flex tw-items-center tw-space-x-1 md:tw-space-x-3">
            ...
            <li aria-current="page">
              <div class="tw-flex items-center">
                ...
                <span
                    class="tw-text-gray-400 tw-ml-1 md:tw-ml-2 tw-text-sm tw-font-medium dark:tw-text-gray-500">{{ $route.params.url.replace(/-/g, ' ') | capitalize }}</span>
              </div>
            </li>
          </ol>
        </nav>
        ...
        <!-- Product Details -->
        <div class="lg:tw-grid lg:tw-grid-cols-2 tw-gap-2 tw-bg-white tw-py-4">
          <div class="">
            <div
            ...
            >
              <img
                  ...
                  :alt="`${raw_product.product.name}-avimar-online`"
                  width="320"
                  height="362"
              />
            </div>
          ...
          <div class="product-quantity tw-px-4">
            <h1 class="tw-text-3xl tw-font-bold tw-tracking-tight tw-text-gray-900">
              {{ raw_product.product.name || '' }}
            </h1>

            <div class="tw-mt-3">
              <h2 class="tw-sr-only">Product information</h2>
              <p class="tw-text-3xl tw-tracking-tight tw-text-gray-900">
                {{ total | currency }}
              </p>
            </div>
                ...
                >
                  ...
                  >
                    <fa
                        icon="heart"
                        title="favorite"
                        style="font-size:1.5em;color:#bd0a0a"
                    ></fa>
                  </b>
                  <b v-else>
                    <fa
  ...
  <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="tw-bg-white tw-shadow-lg tw-mt-2 tw-p-4 tw-mx-auto">
          <div class="tw-m-1">
            ...
            <div
                class="tw-space-y-6 tw-text-base tw-text-gray-700 tw-font-poppins"
