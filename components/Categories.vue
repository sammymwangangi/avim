        ...
        <div class="tw-flex tw-flex-col md:tw-grid md:tw-grid-cols-5 tw-gap-0 tw-bg-white">
            ...
            <div class="tw-flex tw-flex-col tw-gap-2">
                <div class="md:tw-flex tw-grid tw-grid-cols-2 tw-px-4 tw-py-4 tw-gap-2">
                    ...
                    <nuxt-link to="home-and-office" class="tw-flex tw-flex-col md:tw-flex-row tw-items-center tw-px-2 tw-py-2 hover:tw-shadow tw-no-underline tw-justify-center tw-bg-white tw-w-[239px] tw-h-[134px]">
                    ...
                    <nuxt-link to="phones-and-tablets" class="tw-flex tw-flex-col md:tw-flex-row tw-items-center tw-px-2 tw-py-2 hover:tw-shadow tw-no-underline tw-justify-center tw-bg-white tw-w-[239px] tw-h-[134px]">
                    ...
                    <nuxt-link to="laptops" class="tw-flex tw-flex-col md:tw-flex-row tw-items-center tw-px-2 tw-py-2 hover:tw-shadow tw-no-underline tw-justify-center tw-bg-white tw-w-[239px] tw-h-[134px]">
                ...
                <div class="md:tw-flex tw-grid tw-grid-cols-2 tw-px-4 tw-py-4 tw-gap-2">
                    <nuxt-link to="health-and-beauty" class="tw-flex tw-flex-col md:tw-flex-row tw-items-center tw-px-2 tw-py-2 hover:tw-shadow tw-no-underline tw-justify-center tw-bg-white tw-w-[239px] tw-h-[134px]">
                    ...
                    <nuxt-link to="juakali" class="tw-flex tw-flex-col md:tw-flex-row tw-items-center tw-px-2 tw-py-2 hover:tw-shadow tw-no-underline tw-justify-center tw-bg-white tw-w-[239px] tw-h-[134px]">
                    ...
                    <nuxt-link to="autoparts" class="tw-flex tw-flex-col md:tw-flex-row tw-items-center tw-px-2 tw-py-2 hover:tw-shadow tw-no-underline tw-justify-center tw-bg-white tw-w-[239px] tw-h-[134px]">
                    ...
                    <nuxt-link to="others" class="tw-flex tw-flex-col md:tw-flex-row tw-items-center tw-px-2 tw-py-2 hover:tw-shadow tw-no-underline tw-justify-center tw-bg-white tw-w-[239px] tw-h-[134px]">
