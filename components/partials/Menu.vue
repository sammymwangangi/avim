<template>
  <div>
          ...
          >
            ...
            <template v-if="isAuthenticated">
              <b-dropdown-item
                ...
                ><fa icon="tachometer-alt"></fa> Dashboard</b-dropdown-item
              >
              <b-dropdown-item
            ...
            <template v-else>
              ...
              <b-dropdown-item
                ...
                style="font-size: 1.1em;"
                ><fa icon="pen" title="register"></fa> Register</b-dropdown-item
              >
            </template>
          </b-dropdown>
        </div>
    ...
    <nav
      ...
      style="margin-top:70px; height: 4rem"
      id="navbarNav"
    >
      <div class="container-fluid">
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav tw-items-center mx-auto">
            <li class="nav-item">
              <NuxtLink to="/">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="tw-h-6 tw-w-6 tw-text-white"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21h7.5V10.75M2.25 21h1.5m18 0h-18M2.25 9l4.5-1.636M18.75 3l-1.5.545m0 6.205l3 1m1.5.5l-1.5-.5M6.75 7.364V3h-3v18m3-13.636l10.5-3.819"></path></svg>
              </NuxtLink>
            </li>
            <li
      ...
      <div class="container-fluid">
        ...
        >
          ...
          <ul class="float-right navbar-nav tw-items-center tw-right-0">
            <li class="nav-item">
              <a
                class="tw-text-gray-900 tw-no-underline tw-cursor-pointer tw-font-medium tw-text-lg"
